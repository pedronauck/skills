...
### Schema.TaggedError Pattern (Serializable Errors)

Pattern for serializable, schema-validated errors used in CLI, HTTP APIs, and distributed systems:

```typescript
import * as Schema from "effect/Schema"

// Basic serializable error - has _tag for discrimination + schema validation
...
// CLI error example
class CliError extends Schema.TaggedError<CliError>()(
  "CliError",
  {
...
// HTTP API error with custom message
class HttpApiDecodeError extends Schema.TaggedError<HttpApiDecodeError>()(
  "HttpApiDecodeError",
  {
    message: Schema.String,
...
// AI service error with computed message
class AiError extends Schema.TaggedError<AiError>()(
  "AiError",
  {
...
// When to use Schema.TaggedError:
...
- [ ] Schema.TaggedError used for errors crossing service boundaries
